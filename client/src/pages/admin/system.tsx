...
import PricingCalibratePage from "@/pages/admin/calibrate";
    ...
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 pt-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm">System health, Square catalog, pricing calibration, and configuration</p>
        </div>
        <Tabs defaultValue="check">
          <TabsList className="bg-slate-800/50 border border-slate-700/50 mb-6 flex-wrap">
            ...
            <TabsTrigger value="calibrate" className="data-[state=active]:bg-teal-600/20 data-[state=active]:text-teal-300">Pricing Calibration</TabsTrigger>
