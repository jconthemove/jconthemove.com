...
export default function AdminLaunchChecklistPage() {
  ...
  const reportText = useMemo(() => {
    const lines = [
      ...
      "Coverage: health/readiness, payments, booking funnel, quick requests with photos/media links, worker rep pages, profit share, payout safety",
      "",
      ...scenarios.map((s) => {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between mb-2">
        <div>
          ...
          <p className="text-slate-400 text-sm max-w-3xl">
            Run every launch probe and confirm all rows are green before publishing a deploy or driving marketing traffic. This covers health/readiness, payments, the booking funnel, quick-request photos, media links and attribution, worker rep pages, profit-share defaults, and payout safety.
          </p>
        </div>
        <button
          onClick={copyReport}
