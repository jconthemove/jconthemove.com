...
const tabs = [
  ...
  { label: "Jobs", icon: Briefcase, path: "/my-jobs" },
  { label: "Post", icon: PlusCircle, path: "/post-job" },
          ...
          if (isPost) {
            return (
              ...
              >
                ...
                <span className="text-[10px] font-semibold mt-0.5 text-jc-orange">Post</span>
              </button>
            );
          }
