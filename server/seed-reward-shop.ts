...
function buildItems(catMap: Record<string, number>) {
  return [
    ...
    // ── 🚛 Premium Moving ─────────────────────────────────────────────────────
    {
      ...
      fullDesc: "Redeem 110,000 JCMOVES for 2 movers working for 1 full hour at no labor charge. Local Ironwood area jobs — completely free. Outside the area? You cover travel; the labor is on us.",
      tokenPrice: 110000, cashValue: "150.00", status: "active", featured: false,
    ...
    },
    {
      ...
      fullDesc: "Redeem 220,000 JCMOVES for 2 movers, 2 hours — no labor charge. Our most popular moving package, completely free for loyal customers. Local area moves only; travel extra for longer distances.",
      tokenPrice: 220000, cashValue: "300.00", status: "active", featured: true,
      deliveryType: "service_credit", createsInvoiceCredit: true, requiresSchedule: true, requiresApproval: true,
